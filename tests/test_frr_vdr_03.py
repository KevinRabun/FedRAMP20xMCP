"""
Tests for FRR-VDR-03: Timeframe Requirements
"""
...
from fedramp_20x_mcp.analyzers.frr.frr_vdr_03 import FRR_VDR_03_Analyzer
from fedramp_20x_mcp.analyzers.base import Severity


# TODO: Implement tests for FRR-VDR-03
# Follow the pattern from test_frr_vdr_08.py and test_frr_ucm_02.py


def test_analyzer_metadata():
    """Test FRR-VDR-03 analyzer metadata."""
    analyzer = FRR_VDR_03_Analyzer()
    
    assert analyzer.FRR_ID == "FRR-VDR-03", "FRR_ID should be FRR-VDR-03"
    assert analyzer.FAMILY == "VDR", "Family should be VDR"
    assert analyzer.FRR_NAME == "Timeframe Requirements", "Title mismatch"
