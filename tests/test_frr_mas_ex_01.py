"""
Tests for FRR-MAS-EX-01: Supplemental Information
"""
...
from fedramp_20x_mcp.analyzers.frr.frr_mas_ex_01 import FRR_MAS_EX_01_Analyzer
from fedramp_20x_mcp.analyzers.base import Severity


# TODO: Implement tests for FRR-MAS-EX-01
# Follow the pattern from test_frr_vdr_08.py and test_frr_ucm_02.py


def test_analyzer_metadata():
    """Test FRR-MAS-EX-01 analyzer metadata."""
    analyzer = FRR_MAS_EX_01_Analyzer()
    
    assert analyzer.FRR_ID == "FRR-MAS-EX-01", "FRR_ID should be FRR-MAS-EX-01"
    assert analyzer.FAMILY == "MAS", "Family should be MAS"
    assert analyzer.FRR_NAME == "Supplemental Information", "Title mismatch"
...
def test_evidence_automation_recommendations():
    ...
    assert recommendations['frr_id'] == "FRR-MAS-EX-01", "FRR_ID mismatch"
...
def run_all_tests():
    ...
    print("\n" + "=" * 70)
    print(f"Running FRR-MAS-EX-01 Tests ({len(test_functions)} tests)")
    print("=" * 70 + "\n")
