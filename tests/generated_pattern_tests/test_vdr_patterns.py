...
resource example 'Microsoft.Resources/tags@2022-09-01' = {}"""
        ...
        findings = [f for f in result.findings if "vdr.scanning.defender_for_cloud" in f.requirement_id]
...
"""
    ...
    def test_vdr_scanning_ci_cd_scanning_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.scanning.ci_cd_scanning" in f.requirement_id]
    ...
    def test_vdr_scanning_missing_sast_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.scanning.missing_sast" in f.requirement_id]
    ...
    def test_vdr_scanning_missing_container_scan_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.scanning.missing_container_scan" in f.requirement_id]
...
resource example 'Microsoft.Resources/tags@2022-09-01' = {}"""
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.patching.update_management" in f.requirement_id]
...
"""
    ...
    def test_vdr_patching_outdated_base_image_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.patching.outdated_base_image" in f.requirement_id]
    ...
    def test_vdr_dependencies_dependabot_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.dependencies.dependabot" in f.requirement_id]
...
trigger_pattern = True"""
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.dependencies.outdated_packages" in f.requirement_id]
...
"""
    ...
    def test_vdr_secure_dev_pre_commit_hooks_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.secure_dev.pre_commit_hooks" in f.requirement_id]
    ...
    def test_vdr_secure_dev_code_review_required_positive(self, analyzer):
        ...
        # Should detect the pattern
        findings = [f for f in result.findings if "vdr.secure_dev.code_review_required" in f.requirement_id]
