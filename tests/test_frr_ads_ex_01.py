"""
Tests for FRR-ADS-EX-01: Legacy Self-Managed Repository Exception
"""
...
from fedramp_20x_mcp.analyzers.frr.frr_ads_ex_01 import FRR_ADS_EX_01_Analyzer
from fedramp_20x_mcp.analyzers.base import Severity


# TODO: Implement tests for FRR-ADS-EX-01
# Follow the pattern from test_frr_vdr_08.py and test_frr_ucm_02.py


def test_analyzer_metadata():
    """Test FRR-ADS-EX-01 analyzer metadata."""
    analyzer = FRR_ADS_EX_01_Analyzer()
    
    assert analyzer.FRR_ID == "FRR-ADS-EX-01", "FRR_ID should be FRR-ADS-EX-01"
    assert analyzer.FAMILY == "ADS", "Family should be ADS"
    assert analyzer.FRR_NAME == "Legacy Self-Managed Repository Exception", "Title mismatch"
...
def test_evidence_automation_recommendations():
    ...
    assert recommendations['frr_id'] == "FRR-ADS-EX-01", "FRR_ID mismatch"
...
def run_all_tests():
    ...
    print("\n" + "=" * 70)
    print(f"Running FRR-ADS-EX-01 Tests ({len(test_functions)} tests)")
    print("=" * 70 + "\n")
