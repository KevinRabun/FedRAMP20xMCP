...
def test_analyzer_metadata():
    ...
    assert analyzer.FRR_NAME == "Public Information", "Title mismatch"
...
def test_evidence_automation_recommendations():
    ...
    assert recommendations['frr_id'] == "FRR-ADS-01", "FRR_ID mismatch"
...
def run_all_tests():
    ...
    print("\n" + "=" * 70)
    print(f"Running FRR-ADS-01 Tests ({len(test_functions)} tests)")
    print("=" * 70 + "\n")
